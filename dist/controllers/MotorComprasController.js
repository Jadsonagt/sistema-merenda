...
export class MotorComprasController {
    ...
    async exportarExcelConsolidado(req, res) {
        try {
            ...
            escolas.forEach(escola => {
                const rowData = { escola: escola.name };
