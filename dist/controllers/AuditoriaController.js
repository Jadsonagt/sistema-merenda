...
export class AuditoriaController {
    async gerarListaCompras(req, res) {
        try {
            ...
            const result = await prisma.$transaction(async (tx) => {
                ...
                const necessidadesFracionadas = new Map();
                // 1. Process Cardapios
    ...
    async relatorioDivergencias(req, res) {
        try {
            ...
            const agrupamentoPorItem = {};
            const agrupamentoPorEscola = {};
