...
export class EstoqueController {
     ...
     *         description: Erro interno no servidor
     */
    async salvarInventarioFisico(req, res) {
        try {
            const { escolaId } = req.params;
     ...
     *         description: Erro interno no servidor
     */
    async consultarHistorico(req, res) {
        try {
            const { escolaId } = req.params;
     ...
     */
    async listarHistoricoRemanejamento(req, res) {
        try {
