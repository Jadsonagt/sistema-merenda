...
estoqueRoutes.get('/escolas/:escolaId/estoque', verificarToken, permitirRoles(['ADMIN', 'SUPERVISORA']), estoqueController.listarEstoque);
// Lançamento de Inventário Físico (Sobrescrita em lote)
estoqueRoutes.post('/escolas/:escolaId/inventario', verificarToken, permitirRoles(['ADMIN', 'SUPERVISORA']), estoqueController.salvarInventarioFisico);
// Consulta de Histórico de Inventário
estoqueRoutes.get('/escolas/:escolaId/inventario/historico', verificarToken, permitirRoles(['ADMIN', 'SUPERVISORA']), estoqueController.consultarHistorico);
...
estoqueRoutes.get('/pendencias-processamento', verificarToken, permitirRoles(['ADMIN', 'SUPERVISORA']), estoqueController.verificarPendencias);
