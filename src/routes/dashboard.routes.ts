 ...
 */
dashboardRoutes.get('/resumo', 
  verificarToken, 
  permitirRoles(['ADMIN', 'SUPERVISORA']), 
  dashboardController.resumo
);

dashboardRoutes.get('/divergencias',
  verificarToken,
  permitirRoles(['ADMIN', 'SUPERVISORA']),
  dashboardController.getTopDivergencias
);

dashboardRoutes.get('/vencimentos',
  verificarToken,
  permitirRoles(['ADMIN', 'SUPERVISORA']),
  dashboardController.getVencimentosCriticos
);
